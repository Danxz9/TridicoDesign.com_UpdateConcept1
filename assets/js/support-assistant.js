...
(function () {
  ...
  const PATHS = {
    ...
    navigation: {
      ...
      html: `<p><strong>Fastest website paths:</strong></p><ul><li><a href="work.html">Portfolio</a> - view project examples and portfolio categories.</li><li><a href="services.html">Services</a> - graphic design, print, signs, wraps, branding, and installation.</li><li><a href="shop.html">Shop</a> - explore vehicle graphics and start a vehicle-specific quote.</li><li><a href="process.html">Process</a> - intake, proof, production, and installation.</li><li><a href="quote.html">Get Quote</a> - submit project details.</li><li><a href="upload-artwork.html">Upload Artwork</a> - prepare files for Tridico.</li><li><a href="contact.html">Contact</a> - phone, email, location, and hours.</li></ul>`,
